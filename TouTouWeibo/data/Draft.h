...
@interface Draft : NSObject {
	...
	WeiBoModel *replyToStatus;
	WeiBoModel *replyToComment;
	BOOL comment;
	BOOL retweet;
...
@property (nonatomic, retain) WeiBoModel *replyToStatus;
@property (nonatomic, retain) WeiBoModel *replyToComment;
