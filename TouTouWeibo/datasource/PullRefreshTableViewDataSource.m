...
- (void)doneLoadingTableViewData {
  ...
  //  [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(dataSourceDidFinishLoadingNewData) object:nil];
    //[self performSelector:@selector(dataSourceDidFinishLoadingNewData) withObject:nil afterDelay:.5];
