...
- (id)initWithoutNib {
	if(self = [super init]) {
		...
		userTimelineController = [[UserTimelineController alloc] initWithNibName:@"UserTimelineController" bundle:nil];
		...
		self.hidesBottomBarWhenPushed = YES;
		//@dave add [self.tabBarController.tabBar setHidden:YES];
