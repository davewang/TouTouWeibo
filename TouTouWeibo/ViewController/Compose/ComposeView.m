...
- (void)initButtons {
    ...
    emoticonsButton = [[UIButton alloc] initWithFrame:CGRectMake(blockWidth * 2 + 4, y, blockWidth, blockHeight)];
	...
	[usernamesButton setTitle:@"点名" forState:UIControlStateNormal];
	[hashtagsButton setImage:[self maskImage:[UIImage imageNamed:@"compose-hash.png"]] forState:UIControlStateNormal];
	[hashtagsButton setTitle:@"全站" forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    emoticonsButton.frame = CGRectMake(blockWidth * 2 + 4, y, blockWidth, blockHeight);
