...
{
    if (self = [super init]) {
        directMessageId =  [letter.userId longLongValue];
		text =  letter.postTitle;
		senderId = [letter.userId longLongValue];
		recipientId = [[GlobalInfo sharedGlobalInfo].userId longLongValue];
		createdAt = [CommonUtils getTimeValueForNSString:letter.postTime defaultValue:0]  ;
		senderScreenName = letter.userId;
		recipientScreenName = [GlobalInfo sharedGlobalInfo].userName ;
