...
- (void)setUser:(AccountInfo *)_user {
 ...
 //   NSLog(@"__user.nickname-->%@",_user.nickname);
	screenNameLabel.text = _user.name;
	//locationLabel.text = [NSString stringWithFormat:@"%@ %@",_user.oftenAddressOfProvince,_user.oftenAddress] ;
