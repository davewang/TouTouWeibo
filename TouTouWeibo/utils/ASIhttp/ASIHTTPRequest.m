...
//#endif
    ...
    if ([self isExecuting]) {
        NSLog(@"operation is isExecuting!");
    }
    if ([self isFinished]) {
        NSLog(@"operation is isFinished!");
    }
    if ([self isConcurrent]) {
        NSLog(@"operation is isConcurrent!");
    }
    
    if (([self isConcurrent]&&[self isExecuting])) {
        
        NSLog(@"operation is isConcurrent&&isExecuting!");
    }
